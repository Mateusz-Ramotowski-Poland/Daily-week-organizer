...
btnFormStart.addEventListener("click", function () {
  ...
  nodeTimers[timerNumber].querySelector('.timer-time').textContent = `${minutes}:${seconds}`;
  nodeTimers[timerNumber].querySelector('.description').textContent = `${descriptionInput.value}`;

  console.log(nodeTimers[timerNumber].querySelector('p').textContent);
